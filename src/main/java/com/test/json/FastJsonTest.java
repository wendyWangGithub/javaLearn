...
public class FastJsonTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------------------Dog对象中含有List-----------------");
		...
		for (int i = 0; i < jsonArray.size(); i++) {
			...
			System.out.println(json.getString("height"));
			...
			for (int j = 0; j < jsonHobbyList.size(); j++) {
				...
				System.out.println(jsonHobby.getString("name"));
				System.out.println(jsonHobby.getString("hobbyDescription"));
			}
		}
		...
		//直接解析json数组
		JSONArray jsonArray22 = JSON.parseArray("[{\"height\":130, \"tailColor\":\"black\"},{\"height\":140, \"tailColor\":\"purple\"}]");
